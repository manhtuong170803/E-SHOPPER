                    ...
                    <div class="product-details"><!--product-details-->
                        <div class="col-sm-5">                           
                            ...
                            <div class="view-product">                                  
                                @if($firstImage)
                                    <img id="main-product-image" src="{{ asset('upload/products/' . $firstImage) }}" alt="Product Image" />
                                    <a id="main-product-zoom" href="{{ asset('upload/products/' . $firstImage) }}" rel="prettyPhoto" >
                                        <h3>ZOOM</h3>
                                    </a>
                                @endif                                  
                            </div>
                                <div id="similar-product" class="carousel slide" data-ride="carousel">
                                       ...
                                       <!-- Wrapper for slides -->
                                        ...
                                        @for ($i = 0; $i < $imagesPerSlide; $i++)
                                            <div class="item {{ $i == 0 ? 'active' : '' }}">
                                                @for ($j = 0; $j < count($images); $j++)
                                                    <a href="javascript:void(0);" class="thumbnail-image"  
                                                        data-image="{{ asset('upload/products/' . $images[$j]) }}" 
                                                        data-fullsize="{{ asset('upload/products/' . $images[$j]) }}">
                                                        <img src="{{ asset('upload/products/' . $images[$j]) }}" alt="Product Image {{ $j }}" width="84">
                                                    </a>
                                                @endfor
                                            </div>
                                        @endfor
                        ...
                        <div class="col-sm-7">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <span>
                                    ...
                                    <button type="button" class="btn btn-fefault cart add-to-cart" data-id="{{ $products->id }}">
                                        <i class="fa fa-shopping-cart"></i>
                                        Add to cart
                                    </button>
                                </span>
                                <p><b>Availability:</b> In Stock</p>
                                <p><b>Condition:</b> {{ $products->status == 1 ? 'New' : ($products->status == 2 ? 'Sale' : 'N/A') }}</p>
                                <p><b>Category:</b> {{ $products->category ? $products->category->name : 'N/A' }}</p> 
                                <p><b>Brand:</b> {{ $products->brand ? $products->brand->name : 'N/A' }}</p> 
	...
	<script>   	
    	...
    	$(document).ready(function(){
            ...
            $('.thumbnail-image').on('click', function() {
                ...
                var fullsizeUrl = $(this).data('fullsize');

                $('#main-product-image').attr('src', imageUrl);

                $('#main-product-zoom').attr('href', fullsizeUrl);
            });
