...
class MemberProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = DB::table('products')->where('id_user', $userId)->get();
        return view('frontend.member.my-product', compact('products'));
    }
    ...
    public function add()
    {
        ...
        $brandies = Brand::all();
        return view('frontend.member.add-product', compact('categories','brandies'));
        // return view('frontend.member.add-product');
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $brandies = Brand::all();
        return view('frontend.member.edit-product', compact('editproduct','categories','brandies'));
    }
    ...
    public function update(ProductRequest $request, $id)
    {
        if (Auth::check()) {
            ...
            if ($totalImages > 3) {
                return back()->withErrors('Tổng số hình ảnh không được vượt quá 3');
            }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('frontend.member.my-product')->with('success', 'Sản phẩm đã được xóa thành công.');
    }
}
